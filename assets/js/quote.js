$(document).ready(function () {
    ...
    $('#options').on('click', function () {
        let radio = document.getElementsByName("radio-btn");
        let selected = Array.from(radio).find(element => element.checked);
        ...
        doCalc();
        }else if (selected.value =="excelium"){
    ...
    function getProdRange() {
        if ($('#standard').is(':checked')) {
            ...
            prodRange.installationFeePercentage = 0.10;
            return prodRange;
    ...
    function setPricesResults(finNumElev, roughTotal, installFee, total) {
        //$("#numElev_2").val(Number(finNumElev));
