$(document).ready(function () {
    ...
    // -------- get information -------- //
    function getInfoNumApp() { //Appartements//
        numApp = $('#numApp').val();
    };
    function getInfoNumFloors() { //Floors//
        numFloors = $('#numFloors').val();
    };
    function getInfoNumBase() { //Basements//
        numBase = $('#numBase').val();
    };
    function getInfoNumComp() { //Companies//
        numComp = $('#numComp').val();
    }
    function getInfoNumPark() { //ParkingSpots//
        numPark = $('#numPark').val();
    }
    function getInfoNumElev() { //ElevatorsShaft//
        numElev = $('#numElev').val();
    };
    function getInfoMaxOcc() { //MaximumOccupants//
        maxOcc = $('#maxOcc').val();
    };
